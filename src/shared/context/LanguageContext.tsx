...
const translations = {
  en: {
    ...
    "dashboard.trackHealth": `Boost productivity and protect your health at the computer. Track your posture, vision, and work mode — earn points and compete in the leaderboard!`,
    ...
    "profile.enterCurrentPassword":
      "Enter current password (required for password change)",
    ...
    "subscription.subtitle":
      "Unlock advanced features to take your health monitoring to the next level",
    ...
    "vision.whyImportant.rule":
      "Every 20 minutes, look at an object 20 feet (6 meters) away",
    "vision.whyImportant.duration": "For 20 seconds",
    "vision.whyImportant.strain": "This reduces eye strain and prevents myopia",
    "vision.whyImportant.computer":
      "Especially important when working at a computer",
    "vision.start": "Start",
    "vision.stop": "Stop",
    "vision.reset": "Reset",
    ...
    "vision.ruleDescription":
      "20-20-20 Rule: every 20 minutes of computer work, look at an object 20 feet (6 meters) away for 20 seconds",
    ...
    "posture.cameraDescription":
      "The camera is used locally for pose analysis. Only aggregated events without images are sent to the server.",
    "posture.monitoring": "Monitoring...",

    // Work Mode
    "workmode.title": "Work Mode",
    "workmode.subtitle":
      "Optimize your work environment for productivity and health",
    "workmode.pomodoroTechnique": "Pomodoro Technique",
    "workmode.pomodoroDescription":
    ...
    "workmode.science1":
      "Research shows that the human brain can maintain high focus for about 20-25 minutes",
    ...
    "achievements.noAchievements":
      "No achievements yet. Keep working on your health habits!",
  ...
  ru: {
    ...
    "dashboard.trackHealth":
      "Повышай продуктивность и береги здоровье за компьютером. Следи за осанкой, зрением и режимом работы — зарабатывай баллы и побеждай в рейтинге!",
    ...
    "dashboard.signInToStart":
      "Войдите, чтобы начать отслеживать здоровье и соревноваться с коллегами",
    ...
    "auth.subtitle":
      "Отслеживайте привычки здоровья и улучшайте продуктивность",
    ...
    "profile.passwordChangeNote":
      "Оставьте поля пароля пустыми, если не хотите изменить пароль.",
    "profile.currentPassword": "Текущий пароль",
    "profile.enterCurrentPassword":
      "Введите текущий пароль (требуется для смены пароля)",
    ...
    "subscription.subtitle":
      "Откройте расширенные функции для улучшения мониторинга здоровья",
    ...
    "pomodoro.subtitle":
      "Работайте сосредоточенно, делайте перерывы, оставайтесь здоровыми",
    "pomodoro.whyImportant.title": "Почему это важно?",
    "pomodoro.whyImportant.subtitle":
      "Регулярные перерывы каждые 25 минут помогают:",
    ...
    "vision.whyImportant.rule":
      "Каждые 20 минут смотрите на объект в 20 футах (6 метрах)",
    "vision.whyImportant.duration": "В течение 20 секунд",
    "vision.whyImportant.strain":
      "Это снижает напряжение глаз и предотвращает близорукость",
    ...
    "vision.ruleDescription":
      "Правило 20-20-20: каждые 20 минут работы за компьютером смотрите на объект в 20 футах (6 метрах) в течение 20 секунд",

    // Posture
    "posture.title": "Мониторинг осанки",
    "posture.whyImportant.title": "Почему это важно?",
    "posture.whyImportant.subtitle":
      "Правильная осанка за компьютером предотвращает:",
    ...
    "posture.cameraDescription":
      "Камера используется локально для анализа позы. На сервер отправляются только агрегированные события без изображений.",
    "posture.monitoring": "Мониторинг...",

    // Work Mode
    "workmode.title": "Режим работы",
    "workmode.subtitle":
      "Оптимизируйте рабочую среду для продуктивности и здоровья",
    "workmode.pomodoroTechnique": "Техника Помодоро",
    "workmode.pomodoroDescription":
      "Техника Помодоро — это метод управления временем, разработанный Франческо Чирилло в конце 1980-х годов. Он использует таймер для разделения работы на интервалы, традиционно по 25 минут, разделенные короткими перерывами.",
    ...
    "workmode.science1":
      "Исследования показывают, что человеческий мозг может поддерживать высокую концентрацию около 20-25 минут",
    "workmode.science2":
      "Короткие перерывы помогают предотвратить усталость от принятия решений",
    "workmode.science3":
      "Регулярные перерывы улучшают общую когнитивную производительность",
    ...
    "achievements.noAchievements":
      "Пока нет достижений. Продолжайте работать над привычками здоровья!",
