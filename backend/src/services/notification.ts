...
export class NotificationService {
  ...
  async sendAchievementEmail(user: User, achievementName: string, achievementDescription: string): Promise<boolean> {
  ...
  async sendDailyReminder(user: User): Promise<boolean> {
  ...
  async sendBulkEmail(templateKey: string, customData?: Record<string, string>): Promise<{
    total: number;
    sent: number;
    failed: number;
  }> {
